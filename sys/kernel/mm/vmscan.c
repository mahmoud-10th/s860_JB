...
#ifdef CONFIG_MTKPASR_DEBUG 
int pasr1 = 0, pasr2 = 0, pasr3 = 0, pasr4 = 0;
int pasr5 = 0, pasr6 = 0, pasr7 = 0, pasr8 = 0;
int pasr9 = 0, pasra = 0, pasrb = 0, pasrc = 0;
int pasrd = 0, pasre = 0, pasrf = 0, pasr0 = 0;
int pasr5_fail = 0, pasr5_again = 0;
int pasr_e = 0;
int pasr_exec = 0;
int pasr_alocked = 0, pasr_klocked = 0;
int sbd = 0, fbd = 0;
#endif
...
int mtkpasr_drop_page(struct page *page)
{
	...
	/* Check whether it is dirtied. We have filtered out dirty file pages above. 
