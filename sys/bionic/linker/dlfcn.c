...
int (*load_library_notify_ion) (const char *name,uintptr_t address,uintptr_t size ) = NULL;
int (*unload_library_notify_ion) (const char *name, uintptr_t address) = NULL;
...
{
     pthread_mutex_lock(&dl_lock);
     load_library_notify_ion = load_notify_function;
     unload_library_notify_ion = unload_notify_function;
     pthread_mutex_unlock(&dl_lock);
}
...
{
     pthread_mutex_lock(&dl_lock);
     load_library_notify_ion = NULL;
     unload_library_notify_ion = NULL;
     pthread_mutex_unlock(&dl_lock);
}

#if defined(ANDROID_ARM_LINKER)
//                     0000000 00011111 111112 22222222 2333333 333344444444445555555 5556666666666777777777788888 88888999999999
//                     0123456 78901234 567890 12345678 9012345 678901234567890123456 7890123456789012345678901234 567890123456789012345678901234
#define ANDROID_LIBDL_STRTAB \
                      "dlopen\0dlclose\0dlsym\0dlerror\0dladdr\0dl_unwind_find_exidx\0dl_register_notify_function\0dl_unregister_notify_function\0"
...
static Elf32_Sym libdl_symtab[] = {
    ...
    { st_name: 57,
      st_value: (Elf32_Addr) &dl_register_notify_function,
      st_info: STB_GLOBAL << 4,
      st_shndx: 1,
    },
    { st_name: 85,
      st_value: (Elf32_Addr) &dl_unregister_notify_function,
      st_info: STB_GLOBAL << 4,
      st_shndx: 1,
    },
#elif defined(ANDROID_X86_LINKER) || defined(ANDROID_MIPS_LINKER)
