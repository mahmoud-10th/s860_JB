 ...
 * Debug configuration
******************************************************************************/
#define TAG_NAME "[lenovodummy_flashlight.c]"
...
User interface
*****************************************************************************/
static int lenovodummy_flashlight_ioctl(MUINT32 cmd, MUINT32 arg)
{
    int i4RetValue = 0;
...
static int lenovodummy_flashlight_open(void *pArg)
{
    return 0;
}

static int lenovodummy_flashlight_release(void *pArg)
{
    return 0;
}

FLASHLIGHT_FUNCTION_STRUCT	lenovodummyFlashlightFunc=
{
	lenovodummy_flashlight_open,
	lenovodummy_flashlight_release,
	lenovodummy_flashlight_ioctl
};

MUINT32 lenovodummyFlashlightInit(PFLASHLIGHT_FUNCTION_STRUCT *pfFunc) {
    if (pfFunc!=NULL) {
        *pfFunc=&lenovodummyFlashlightFunc;
    }
    return 0;
}
