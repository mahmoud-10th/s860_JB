...
/*lenovo-sw chenglong1 2013-10-15 add for lenovo flash begin*/
MUINT32 LenovoFlashlightInit(PFLASHLIGHT_FUNCTION_STRUCT *pfFunc);
/*lenovo-sw add end*/
...
#endif
/*lenovo-sw chenglong1 2013-10-15 add for lenovo flash begin*/
#if defined(LENOVOFLASH)
	{LenovoFlashlightInit},
#endif
/*lenovo-sw add end*/
