...
static long AudDrv_ioctl(struct file *fp, unsigned int cmd, unsigned long arg)
{
    ...
    switch (cmd)
    {
		...
		#if (defined(LENOVO_PROJECT_SOFINA) || defined(LENOVO_PROJECT_SOFINATD))
			mt_set_gpio_dir(GPIO_HPPA_EN_PIN, GPIO_DIR_OUT);
			mt_set_gpio_out(GPIO_HPPA_EN_PIN, GPIO_OUT_ONE);
            msleep(15);
		#elif (defined(LENOVO_PROJECT_STELLA) ||defined(LENOVO_PROJECT_PHAETON) || defined(LENOVO_PROJECT_PHAETONTD)) //|| defined(LENOVO_PROJECT_SCOFIELD))
		...
		#if (defined(LENOVO_PROJECT_SOFINA) || defined(LENOVO_PROJECT_SOFINATD))
			mt_set_gpio_dir(GPIO_HPPA_EN_PIN, GPIO_DIR_OUT);
			mt_set_gpio_out(GPIO_HPPA_EN_PIN, GPIO_OUT_ZERO);
            msleep(15);
		#elif (defined(LENOVO_PROJECT_STELLA) ||defined(LENOVO_PROJECT_PHAETON) || defined(LENOVO_PROJECT_PHAETONTD)) //|| defined(LENOVO_PROJECT_SCOFIELD))
			mt_set_gpio_dir(GPIO_HPTPA6136_HI_Z_PIN, GPIO_DIR_OUT); //Hi_Z
			mt_set_gpio_out(GPIO_HPTPA6136_HI_Z_PIN, GPIO_OUT_ZERO);
