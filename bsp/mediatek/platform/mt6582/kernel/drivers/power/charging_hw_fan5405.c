...
/*lenovo-sw weiweij added for 500ma charger voltage protect*/
#if 0        
    fan5405_config_interface_liao(0x05,0x03);
#else
   fan5405_config_interface_liao(0x05,0x06);
#endif
/*lenovo-sw weiweij added for 500ma charger voltage protect end*/
