...
#define SN3199_PWM_OUT1_RGB1_G_REG 0x07
#define SN3199_PWM_OUT2_RGB1_R_REG 0x08
#define SN3199_PWM_OUT3_RGB1_B_REG 0x09

#define SN3199_PWM_OUT4_RGB2_G_REG 0x0A
#define SN3199_PWM_OUT5_RGB2_R_REG 0x0B
#define SN3199_PWM_OUT6_RGB2_B_REG 0x0C

#define SN3199_PWM_OUT7_RGB3_G_REG 0x0D
#define SN3199_PWM_OUT8_RGB3_R_REG 0x0E
...
#define SN3199_T0_OUT1_RGB1_G_REG 0x11
#define SN3199_T0_OUT2_RGB1_R_REG 0x12
#define SN3199_T0_OUT3_RGB1_B_REG 0x13
#define SN3199_T0_OUT4_RGB2_G_REG 0x14
#define SN3199_T0_OUT5_RGB2_R_REG 0x15
#define SN3199_T0_OUT6_RGB2_B_REG 0x16
#define SN3199_T0_OUT7_RGB3_G_REG 0x17
#define SN3199_T0_OUT8_RGB3_R_REG 0x18
...
#define SN3199_T4_OUT1_RGB1_G_REG 0x1D
#define SN3199_T4_OUT2_RGB1_R_REG 0x1E
#define SN3199_T4_OUT3_RGB1_B_REG 0x1F
#define SN3199_T4_OUT4_RGB2_G_REG 0x20
#define SN3199_T4_OUT5_RGB2_R_REG 0x21
#define SN3199_T4_OUT6_RGB2_B_REG 0x22
#define SN3199_T4_OUT7_RGB3_G_REG 0x23
#define SN3199_T4_OUT8_RGB3_R_REG 0x24
...
sn3199_write_reg(0x00, 0x01);
sn3199_write_reg(0x07, 0xFF);
sn3199_write_reg(0x10, 0x00);
...
//	sn3199_write_reg(0x03, 0x00);//PWM mode

	sn3199_write_reg(0x07, 0xFF);
	sn3199_write_reg(0x08, 0xFF);
	sn3199_write_reg(0x09, 0x00);

	sn3199_write_reg(0x0A, 0xFF);
	sn3199_write_reg(0x0B, 0x00);
	sn3199_write_reg(0x0C, 0xFF);
	
	sn3199_write_reg(0x0D, 0x00);
	sn3199_write_reg(0x0E, 0xFF);
	sn3199_write_reg(0x0F, 0xFF);

/*	sn3199_write_reg(0x11, 0x00);
	sn3199_write_reg(0x12, 0x00);
	sn3199_write_reg(0x13, 0x00);
	sn3199_write_reg(0x14, 0x00);
	sn3199_write_reg(0x15, 0x00);
	...
	sn3199_write_reg(0x1A, 0x00);
	sn3199_write_reg(0x1B, 0x00);
	sn3199_write_reg(0x1C, 0x00);

	sn3199_write_reg(0x1D, 0x00);
	sn3199_write_reg(0x1E, 0x00);
	sn3199_write_reg(0x1F, 0x00);
	sn3199_write_reg(0x20, 0x00);
	sn3199_write_reg(0x21, 0x00);
...
void sn3199_rgb_factory_test_5(void)
	{
		LEDS_DEBUG("[LED]%s\n", __func__);
		...
		sn3199_write_reg(0x03, 0x70);//PWM mode
		
		sn3199_write_reg(0x07, 0xFF);
	
		sn3199_write_reg(0x0B, 0xFF);
	...
	//t0~t4
		...
		sn3199_write_reg(0x17, 0x00);
		sn3199_write_reg(0x18, 0x00);
		sn3199_write_reg(0x19, 0x00);//t0
	
		sn3199_write_reg(0x1A, 0x32);//t1 t2 t3
		sn3199_write_reg(0x1B, 0x32);
		sn3199_write_reg(0x1C, 0x32);//B=3;A=2
		...
		sn3199_write_reg(0x23, 0x00);
		sn3199_write_reg(0x24, 0x00);
		sn3199_write_reg(0x25, 0x00);//t4
		
		sn3199_write_reg(0x10, 0x00);//refresh data	
		sn3199_write_reg(0x26, 0x00);//refresh timmer
...
printk("[JX] %s, pwm_data:0x%x, delay_on:0x%x, delay_off:ox%x\n",__func__,pwm_data,delay_on,delay_off);
	...
	if(turn_on){
		...
		sn3199_write_reg(SN3199_PWM_OUT1_RGB1_G_REG, pwm_rgb1_g);
		sn3199_write_reg(SN3199_PWM_OUT2_RGB1_R_REG, pwm_rgb1_r);
		sn3199_write_reg(SN3199_PWM_OUT3_RGB1_B_REG, pwm_rgb1_b);
		sn3199_write_reg(SN3199_PWM_OUT4_RGB2_G_REG, pwm_rgb2_g);
		sn3199_write_reg(SN3199_PWM_OUT5_RGB2_R_REG, pwm_rgb2_r);
		sn3199_write_reg(SN3199_PWM_OUT6_RGB2_B_REG, pwm_rgb2_b);
		sn3199_write_reg(SN3199_PWM_OUT7_RGB3_G_REG, pwm_rgb3_g);
		sn3199_write_reg(SN3199_PWM_OUT8_RGB3_R_REG, pwm_rgb3_r);
		...
		//t0~t4
		sn3199_write_reg(SN3199_T0_OUT1_RGB1_G_REG, t0_rgb1_g);//t0
		sn3199_write_reg(SN3199_T0_OUT2_RGB1_R_REG, t0_rgb1_r);
		sn3199_write_reg(SN3199_T0_OUT3_RGB1_B_REG, t0_rgb1_b);
		sn3199_write_reg(SN3199_T0_OUT4_RGB2_G_REG, t0_rgb2_g);
		sn3199_write_reg(SN3199_T0_OUT5_RGB2_R_REG, t0_rgb2_r);
		sn3199_write_reg(SN3199_T0_OUT6_RGB2_B_REG, t0_rgb2_b);
		sn3199_write_reg(SN3199_T0_OUT7_RGB3_G_REG, t0_rgb3_g);
		sn3199_write_reg(SN3199_T0_OUT8_RGB3_R_REG, t0_rgb3_r);
		...
		sn3199_write_reg(SN3199_T4_OUT1_RGB1_G_REG, t4_rgb1_g);//t4
		sn3199_write_reg(SN3199_T4_OUT2_RGB1_R_REG, t4_rgb1_r);
		sn3199_write_reg(SN3199_T4_OUT3_RGB1_B_REG, t4_rgb1_b);
		sn3199_write_reg(SN3199_T4_OUT4_RGB2_G_REG, t4_rgb2_g);
		sn3199_write_reg(SN3199_T4_OUT5_RGB2_R_REG, t4_rgb2_r);
		sn3199_write_reg(SN3199_T4_OUT6_RGB2_B_REG, t4_rgb2_b);
		sn3199_write_reg(SN3199_T4_OUT7_RGB3_G_REG, t4_rgb3_g);
		sn3199_write_reg(SN3199_T4_OUT8_RGB3_R_REG, t4_rgb3_r);
...
static int __init sn3199_leds_platform_probe(struct platform_device *pdev)
{
	...
	g_sn3199_leds_data[0]->gpio = GPIO_LED_EN;
	...
	g_sn3199_leds_data[1]->gpio = GPIO_LED_EN;
