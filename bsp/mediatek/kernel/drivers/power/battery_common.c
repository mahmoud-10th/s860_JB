...
#if defined(LENOVO_PROJECT_AUX) || defined(LENOVO_CTP_GLOVE_CONTROL)
...
//lenovo-sw yexh1 2014_01_07 modify: turn off OTG 5v output, when phone power off. 
//otherwise, it will cause phone enter power off charging.
