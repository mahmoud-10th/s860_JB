...
#define LENOVO_EXT_LED_RED		0x00000080 //0x000000ff
#define LENOVO_EXT_LED_ORANGE	0x00004080 //0x000080ff
#define LENOVO_EXT_LED_GREEN	0x00008000 //0x0000ff00
...
static int lenovo_is_h_charger = 0;
