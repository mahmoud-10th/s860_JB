...
/* lenovo-sw zhouwl, 2013-07-10, compatible accdet interrupt */
    ...
    if (cur_eint_state == EINT_PIN_PLUG_IN) {
		...
		#if (defined(LENOVO_PROJECT_PHAETON) || defined(LENOVO_PROJECT_PHAETONTD)) //|| defined(LENOVO_PROJECT_SCOFIELD))
...
/* LENOVO.SW END.chenyb1,2012.9.4, add for new standard */				
	...
	case STAND_BY:
		...
		/* lenovo-sw zhouwl, 2013-10-12, for FSA8049 */
		#if 0//(defined(LENOVO_PROJECT_PHAETON) || defined(LENOVO_PROJECT_PHAETONTD)) //|| defined(LENOVO_PROJECT_SCOFIELD))
		msleep(400);
		mt_set_gpio_dir(GPIO_HPTPA6136_HI_Z_PIN, GPIO_DIR_OUT); //Hi_Z
		...
		mt_set_gpio_out(GPIO_HPTPA6136_SDB_PIN, GPIO_OUT_ZERO);
                ACCDET_DEBUG("[Accdet] zhouwl, disable pa\n");
		#endif
		/* lenovo-sw zhouwl, 2013-10-12, for FSA8049 */
